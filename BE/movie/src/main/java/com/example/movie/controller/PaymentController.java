...
import com.example.movie.config.VnPay;
...
public class PaymentController {
    ...
    @PostMapping("/create/{total}/{idPacked}")
    public ResponseEntity<?> create(@PathVariable Long total,@PathVariable("idPacked")Long id)
...
//        vnp_Params.put("vnp_Id", String.valueOf(id));
